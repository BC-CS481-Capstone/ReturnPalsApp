package com.example.returnpals.guestpackageinfoshowlabel
...
/**
 * This composable was generated from the UI Package 'guest_package_info_show_label'.
 * Generated code; do not edit directly
 */
@Composable
fun GuestPackageInfoShowLabel(modifier: Modifier = Modifier) {
...
@Composable
private fun GuestPackageInfoShowLabelPreview() {
    MaterialTheme {
        RelayContainer {
            GuestPackageInfoShowLabel(modifier = Modifier.rowWeight(1.0f).columnWeight(1.0f))
        }
    }
}
...
fun Background(modifier: Modifier = Modifier) {
    RelayVector(
        vector = painterResource(R.drawable.guest_package_info_show_label_background),
...
fun Rectangle56(modifier: Modifier = Modifier) {
    RelayVector(
        vector = painterResource(R.drawable.guest_package_info_show_label_rectangle_56),
...
fun Ellipse18(modifier: Modifier = Modifier) {
    RelayVector(
        vector = painterResource(R.drawable.guest_package_info_show_label_ellipse_18),
...
fun Line6(modifier: Modifier = Modifier) {
    RelayVector(
        vector = painterResource(R.drawable.guest_package_info_show_label_line_6),
...
fun Ellipse19(modifier: Modifier = Modifier) {
    RelayVector(
        vector = painterResource(R.drawable.guest_package_info_show_label_ellipse_19),
        modifier = modifier.requiredWidth(25.0.dp).requiredHeight(25.0.dp)
    )
}
...
fun Line5(modifier: Modifier = Modifier) {
    RelayVector(
        vector = painterResource(R.drawable.guest_package_info_show_label_line_5),
        modifier = modifier.requiredWidth(50.0.dp).requiredHeight(0.0.dp)
    )
}
...
fun Line4(modifier: Modifier = Modifier) {
    RelayVector(
        vector = painterResource(R.drawable.guest_package_info_show_label_line_4),
        modifier = modifier.requiredWidth(50.0.dp).requiredHeight(0.0.dp)
    )
}
...
fun Line3(modifier: Modifier = Modifier) {
    RelayVector(
        vector = painterResource(R.drawable.guest_package_info_show_label_line_3),
        modifier = modifier.requiredWidth(50.0.dp).requiredHeight(0.0.dp)
    )
}
...
fun Ellipse14(modifier: Modifier = Modifier) {
    RelayVector(
        vector = painterResource(R.drawable.guest_package_info_show_label_ellipse_14),
        modifier = modifier.requiredWidth(25.0.dp).requiredHeight(25.0.dp)
    )
}
...
fun ChoosePlan(modifier: Modifier = Modifier) {
    RelayText(
        ...
        height = 1.25.em,
        maxLines = -1,
        modifier = modifier.requiredWidth(55.0.dp).requiredHeight(20.3134765625.dp).wrapContentHeight(
...
fun Ellipse15(modifier: Modifier = Modifier) {
    RelayVector(
        vector = painterResource(R.drawable.guest_package_info_show_label_ellipse_15),
        modifier = modifier.requiredWidth(25.0.dp).requiredHeight(25.0.dp)
    )
}
...
fun Ellipse20(modifier: Modifier = Modifier) {
    RelayVector(
        vector = painterResource(R.drawable.guest_package_info_show_label_ellipse_20),
        modifier = modifier.requiredWidth(25.0.dp).requiredHeight(25.0.dp)
    )
}
...
fun PickupDate(modifier: Modifier = Modifier) {
    RelayText(
        ...
        height = 1.25.em,
        maxLines = -1,
        modifier = modifier.requiredWidth(55.0.dp).requiredHeight(20.31005859375.dp).wrapContentHeight(
            align = Alignment.CenterVertically,
            unbounded = true
        )
    )
...
fun Vector(modifier: Modifier = Modifier) {
    RelayVector(
        vector = painterResource(R.drawable.guest_package_info_show_label_vector),
...
fun Vector1(modifier: Modifier = Modifier) {
    RelayVector(
        vector = painterResource(R.drawable.guest_package_info_show_label_vector1),
        modifier = modifier.requiredWidth(18.0.dp).requiredHeight(12.760009765625.dp)
    )
}
...
fun Vector2(modifier: Modifier = Modifier) {
    RelayVector(
        vector = painterResource(R.drawable.guest_package_info_show_label_vector2),
        modifier = modifier.requiredWidth(18.0.dp).requiredHeight(12.760009765625.dp)
    )
}
...
fun Rectangle63(modifier: Modifier = Modifier) {
    RelayVector(
        vector = painterResource(R.drawable.guest_package_info_show_label_rectangle_63),
        modifier = modifier.requiredWidth(312.0.dp).requiredHeight(350.4658203125.dp)
    )
}
...
fun Line13(modifier: Modifier = Modifier) {
    RelayVector(
        vector = painterResource(R.drawable.guest_package_info_show_label_line_13),
...
fun NordstromPng(modifier: Modifier = Modifier) {
    RelayText(
        ...
        maxLines = -1,
        modifier = modifier.requiredWidth(94.0.dp).requiredHeight(24.76123046875.dp).wrapContentHeight(
            align = Alignment.CenterVertically,
            unbounded = true
        )
    )
...
fun PackageEntry(
    ...
    RelayContainer(
        ...
        clipToParent = false,
        content = content,
        modifier = modifier.requiredWidth(312.0.dp).requiredHeight(53.331787109375.dp)
    )
}
...
fun Line11(modifier: Modifier = Modifier) {
    RelayVector(
        vector = painterResource(R.drawable.guest_package_info_show_label_line_11),
...
fun Rectangle71(modifier: Modifier = Modifier) {
    RelayVector(
        vector = painterResource(R.drawable.guest_package_info_show_label_rectangle_71),
...
fun MyPackages(modifier: Modifier = Modifier) {
    RelayText(
        ...
        fontWeight = FontWeight(700.0.toInt()),
        maxLines = -1,
        modifier = modifier.requiredWidth(145.0.dp).requiredHeight(39.294677734375.dp).wrapContentHeight(
            align = Alignment.CenterVertically,
            unbounded = true
        )
    )
...
fun Rectangle70(modifier: Modifier = Modifier) {
    RelayVector(
        vector = painterResource(R.drawable.guest_package_info_show_label_rectangle_70),
...
fun Vector3(modifier: Modifier = Modifier) {
    RelayVector(
        vector = painterResource(R.drawable.guest_package_info_show_label_vector3),
...
fun Vector4(modifier: Modifier = Modifier) {
    RelayVector(
        vector = painterResource(R.drawable.guest_package_info_show_label_vector4),
        modifier = modifier.padding(
            paddingValues = PaddingValues(
                start = 4.6875.dp,
...
fun Vector5(modifier: Modifier = Modifier) {
    RelayVector(
        vector = painterResource(R.drawable.guest_package_info_show_label_vector5),
        modifier = modifier.padding(
            paddingValues = PaddingValues(
                start = 0.0.dp,
                top = 0.002197265625.dp,
                end = 0.0.dp,
                bottom = 0.001708984375.dp
            )
        ).fillMaxWidth(1.0f).fillMaxHeight(1.0f)
    )
}
...
fun Rectangle72(modifier: Modifier = Modifier) {
    RelayVector(
        vector = painterResource(R.drawable.guest_package_info_show_label_rectangle_72),
        modifier = modifier.requiredWidth(90.0.dp).requiredHeight(110.0.dp)
    )
}
...
fun Vector6(modifier: Modifier = Modifier) {
    RelayVector(
        vector = painterResource(R.drawable.guest_package_info_show_label_vector6),
        modifier = modifier.padding(
            paddingValues = PaddingValues(
                start = 11.25.dp,
                top = 4.406982421875.dp,
...
fun Vector7(modifier: Modifier = Modifier) {
    RelayVector(
        vector = painterResource(R.drawable.guest_package_info_show_label_vector7),
        modifier = modifier.padding(
            paddingValues = PaddingValues(
                start = 4.6875.dp,
                top = 10.576904296875.dp,
...
fun Vector8(modifier: Modifier = Modifier) {
    RelayVector(
        vector = painterResource(R.drawable.guest_package_info_show_label_vector8),
...
fun Vector9(modifier: Modifier = Modifier) {
    RelayVector(
        vector = painterResource(R.drawable.guest_package_info_show_label_vector9),
        modifier = modifier.padding(
            paddingValues = PaddingValues(
                start = 0.0.dp,
                top = 0.0.dp,
...
fun Vector10(modifier: Modifier = Modifier) {
    RelayVector(
        vector = painterResource(R.drawable.guest_package_info_show_label_vector10),
        modifier = modifier.padding(
            paddingValues = PaddingValues(
...
fun Vector11(modifier: Modifier = Modifier) {
    RelayVector(
        vector = painterResource(R.drawable.guest_package_info_show_label_vector11),
        modifier = modifier.padding(
            paddingValues = PaddingValues(
                start = 0.0.dp,
...
fun Vector12(modifier: Modifier = Modifier) {
    RelayVector(
        vector = painterResource(R.drawable.guest_package_info_show_label_vector12),
        modifier = modifier.padding(
            paddingValues = PaddingValues(
                start = 12.4931640625.dp,
                top = 7.7802734375.dp,
...
fun Vector13(modifier: Modifier = Modifier) {
    RelayVector(
        vector = painterResource(R.drawable.guest_package_info_show_label_vector13),
        modifier = modifier.padding(
            paddingValues = PaddingValues(
...
fun Vector14(modifier: Modifier = Modifier) {
    RelayVector(
        vector = painterResource(R.drawable.guest_package_info_show_label_vector14),
        modifier = modifier.padding(
            paddingValues = PaddingValues(
...
fun Vector15(modifier: Modifier = Modifier) {
    RelayVector(
        vector = painterResource(R.drawable.guest_package_info_show_label_vector15),
        modifier = modifier.padding(
            paddingValues = PaddingValues(
...
fun Vector16(modifier: Modifier = Modifier) {
    RelayVector(
        vector = painterResource(R.drawable.guest_package_info_show_label_vector16),
        modifier = modifier.padding(
            paddingValues = PaddingValues(
...
fun Vector17(modifier: Modifier = Modifier) {
    RelayVector(
        vector = painterResource(R.drawable.guest_package_info_show_label_vector17),
        modifier = modifier.padding(
            paddingValues = PaddingValues(
...
fun Rectangle73(modifier: Modifier = Modifier) {
    RelayVector(
        vector = painterResource(R.drawable.guest_package_info_show_label_rectangle_73),
        modifier = modifier.requiredWidth(90.0.dp).requiredHeight(110.0.dp)
    )
}
...
fun Vector18(modifier: Modifier = Modifier) {
    RelayVector(
        vector = painterResource(R.drawable.guest_package_info_show_label_vector18),
        modifier = modifier.padding(
            paddingValues = PaddingValues(
                start = 11.25.dp,
                top = 4.406982421875.dp,
...
fun Vector19(modifier: Modifier = Modifier) {
    RelayVector(
        vector = painterResource(R.drawable.guest_package_info_show_label_vector19),
        modifier = modifier.padding(
            paddingValues = PaddingValues(
                start = 4.6875.dp,
                top = 10.576904296875.dp,
...
fun Vector20(modifier: Modifier = Modifier) {
    RelayVector(
        vector = painterResource(R.drawable.guest_package_info_show_label_vector20),
        modifier = modifier.fillMaxWidth(1.0f).fillMaxHeight(1.0f)
    )
}
...
fun Vector21(modifier: Modifier = Modifier) {
    RelayVector(
        vector = painterResource(R.drawable.guest_package_info_show_label_vector21),
        modifier = modifier.padding(
            paddingValues = PaddingValues(
                start = 0.0.dp,
                top = 0.0.dp,
...
fun Vector22(modifier: Modifier = Modifier) {
    RelayVector(
        vector = painterResource(R.drawable.guest_package_info_show_label_vector22),
        modifier = modifier.padding(
            paddingValues = PaddingValues(
                start = 12.4931640625.dp,
                top = 0.000244140625.dp,
...
fun Vector23(modifier: Modifier = Modifier) {
    RelayVector(
        vector = painterResource(R.drawable.guest_package_info_show_label_vector23),
        modifier = modifier.padding(
            paddingValues = PaddingValues(
                start = 0.0.dp,
                top = 7.780029296875.dp,
...
fun Vector24(modifier: Modifier = Modifier) {
    RelayVector(
        vector = painterResource(R.drawable.guest_package_info_show_label_vector24),
        modifier = modifier.padding(
            paddingValues = PaddingValues(
                start = 12.4931640625.dp,
                top = 7.7802734375.dp,
...
fun Vector25(modifier: Modifier = Modifier) {
    RelayVector(
        vector = painterResource(R.drawable.guest_package_info_show_label_vector25),
        modifier = modifier.padding(
            paddingValues = PaddingValues(
                start = 1.943359375.dp,
                top = 1.837158203125.dp,
...
fun Vector26(modifier: Modifier = Modifier) {
    RelayVector(
        vector = painterResource(R.drawable.guest_package_info_show_label_vector26),
        modifier = modifier.padding(
            paddingValues = PaddingValues(
                start = 6.05615234375.dp,
                top = 1.837158203125.dp,
...
fun Vector27(modifier: Modifier = Modifier) {
    RelayVector(
        vector = painterResource(R.drawable.guest_package_info_show_label_vector27),
        modifier = modifier.padding(
            paddingValues = PaddingValues(
                start = 10.16845703125.dp,
                top = 1.837158203125.dp,
...
fun Vector28(modifier: Modifier = Modifier) {
    RelayVector(
        vector = painterResource(R.drawable.guest_package_info_show_label_vector28),
        modifier = modifier.padding(
            paddingValues = PaddingValues(
                start = 12.22509765625.dp,
                top = 1.837158203125.dp,
...
fun Vector29(modifier: Modifier = Modifier) {
    RelayVector(
        vector = painterResource(R.drawable.guest_package_info_show_label_vector29),
        modifier = modifier.padding(
            paddingValues = PaddingValues(
                start = 16.337890625.dp,
                top = 1.837158203125.dp,
...
fun Vector30(modifier: Modifier = Modifier) {
    RelayVector(
        vector = painterResource(R.drawable.guest_package_info_show_label_vector30),
        modifier = modifier.padding(
            paddingValues = PaddingValues(
                start = 3.0.dp,
                top = 4.5.dp,
...
fun Vector31(modifier: Modifier = Modifier) {
    RelayVector(
        vector = painterResource(R.drawable.guest_package_info_show_label_vector31),
        modifier = modifier.padding(
            paddingValues = PaddingValues(
