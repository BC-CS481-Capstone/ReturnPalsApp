package com.example.returnpals.packageinfoshowlabel
...
/**
 * This composable was generated from the UI Package 'package_info_show_label'.
 * Generated code; do not edit directly
 */
@Composable
fun PackageInfoShowLabel(modifier: Modifier = Modifier) {
        ...
        Group9899(
            ...
            NounPaper5571925052A421(
                modifier = Modifier.boxAlign(
                    alignment = Alignment.TopStart,
                    offset = DpOffset(
                        x = 24.890480041503906.dp,
                        y = 4.0364990234375.dp
                    )
                )
            ) {
...
@Composable
private fun PackageInfoShowLabelPreview() {
    MaterialTheme {
        RelayContainer {
            PackageInfoShowLabel(modifier = Modifier.rowWeight(1.0f).columnWeight(1.0f))
        }
    }
}
...
fun Background(modifier: Modifier = Modifier) {
    RelayVector(
        vector = painterResource(R.drawable.package_info_show_label_background),
...
fun Rectangle56(modifier: Modifier = Modifier) {
    RelayVector(
        vector = painterResource(R.drawable.package_info_show_label_rectangle_56),
...
fun Ellipse18(modifier: Modifier = Modifier) {
    RelayVector(
        vector = painterResource(R.drawable.package_info_show_label_ellipse_18),
...
fun Line6(modifier: Modifier = Modifier) {
    RelayVector(
        vector = painterResource(R.drawable.package_info_show_label_line_6),
...
fun Ellipse19(modifier: Modifier = Modifier) {
    RelayVector(
        vector = painterResource(R.drawable.package_info_show_label_ellipse_19),
        modifier = modifier.requiredWidth(25.0.dp).requiredHeight(25.0.dp)
    )
}
...
fun Line5(modifier: Modifier = Modifier) {
    RelayVector(
        vector = painterResource(R.drawable.package_info_show_label_line_5),
        modifier = modifier.requiredWidth(50.0.dp).requiredHeight(0.0.dp)
    )
}
...
fun Line4(modifier: Modifier = Modifier) {
    RelayVector(
        vector = painterResource(R.drawable.package_info_show_label_line_4),
        modifier = modifier.requiredWidth(50.0.dp).requiredHeight(0.0.dp)
    )
}
...
fun Line3(modifier: Modifier = Modifier) {
    RelayVector(
        vector = painterResource(R.drawable.package_info_show_label_line_3),
        modifier = modifier.requiredWidth(50.0.dp).requiredHeight(0.0.dp)
    )
}
...
fun Ellipse14(modifier: Modifier = Modifier) {
    RelayVector(
        vector = painterResource(R.drawable.package_info_show_label_ellipse_14),
        modifier = modifier.requiredWidth(25.0.dp).requiredHeight(25.0.dp)
    )
}
...
fun Ellipse15(modifier: Modifier = Modifier) {
    RelayVector(
        vector = painterResource(R.drawable.package_info_show_label_ellipse_15),
        modifier = modifier.requiredWidth(25.0.dp).requiredHeight(25.0.dp)
    )
}
...
fun Ellipse20(modifier: Modifier = Modifier) {
    RelayVector(
        vector = painterResource(R.drawable.package_info_show_label_ellipse_20),
        modifier = modifier.requiredWidth(25.0.dp).requiredHeight(25.0.dp)
    )
}
...
fun Vector(modifier: Modifier = Modifier) {
    RelayVector(
        vector = painterResource(R.drawable.package_info_show_label_vector),
...
fun Vector1(modifier: Modifier = Modifier) {
    RelayVector(
        vector = painterResource(R.drawable.package_info_show_label_vector1),
        modifier = modifier.requiredWidth(18.0.dp).requiredHeight(12.760009765625.dp)
    )
}
...
fun Vector2(modifier: Modifier = Modifier) {
    RelayVector(
        vector = painterResource(R.drawable.package_info_show_label_vector2),
        modifier = modifier.requiredWidth(18.0.dp).requiredHeight(12.760009765625.dp)
    )
}
...
fun Rectangle63(modifier: Modifier = Modifier) {
    RelayVector(
        vector = painterResource(R.drawable.package_info_show_label_rectangle_63),
        modifier = modifier.requiredWidth(312.0.dp).requiredHeight(350.46575927734375.dp)
    )
}
...
fun Line13(modifier: Modifier = Modifier) {
    RelayVector(
        vector = painterResource(R.drawable.package_info_show_label_line_13),
        modifier = modifier.requiredWidth(312.0.dp).requiredHeight(0.0.dp)
    )
}

@Composable
fun Dotdotdot(modifier: Modifier = Modifier) {
    RelayText(
        content = "...",
        fontSize = 40.0.sp,
        fontFamily = cairo,
        ...
        maxLines = -1,
        modifier = modifier.requiredWidth(68.0.dp).requiredHeight(53.10089111328125.dp).wrapContentHeight(
...
@Composable
fun NordstromPng(modifier: Modifier = Modifier) {
    RelayText(
        content = "Nordstrom.png",
        fontFamily = cairo,
        color = Color(
            alpha = 255,
            red = 0,
        ...
        maxLines = -1,
        modifier = modifier.requiredWidth(94.0.dp).requiredHeight(24.76116943359375.dp).wrapContentHeight(
            align = Alignment.CenterVertically,
            unbounded = true
        )
    )
...
@Composable
fun Digital(modifier: Modifier = Modifier) {
    RelayText(
        content = "Digital",
        fontFamily = cairo,
        color = Color(
        ...
        height = 1.874000004359654.em,
        maxLines = -1,
        modifier = modifier.requiredWidth(68.0.dp).requiredHeight(20.9517822265625.dp).wrapContentHeight(
            align = Alignment.CenterVertically,
            unbounded = true
        )
    )
...
fun PackageEntry(
    ...
    RelayContainer(
        ...
        clipToParent = false,
        content = content,
        modifier = modifier.requiredWidth(312.0.dp).requiredHeight(53.33172607421875.dp)
    )
}
...
fun Line11(modifier: Modifier = Modifier) {
    RelayVector(
        vector = painterResource(R.drawable.package_info_show_label_line_11),
        modifier = modifier.requiredWidth(311.6005859375.dp).requiredHeight(0.0.dp)
    )
}
...
fun Rectangle71(modifier: Modifier = Modifier) {
    RelayVector(
        vector = painterResource(R.drawable.package_info_show_label_rectangle_71),
        modifier = modifier.requiredWidth(312.0.dp).requiredHeight(51.043701171875.dp)
    )
}
...
fun Attachment(modifier: Modifier = Modifier) {
    RelayText(
        ...
        height = 1.874000004359654.em,
        maxLines = -1,
        modifier = modifier.requiredWidth(88.0.dp).requiredHeight(28.964111328125.dp).wrapContentHeight(
            align = Alignment.CenterVertically,
            unbounded = true
        )
    )
...
fun LabelType(modifier: Modifier = Modifier) {
    RelayText(
        ...
        height = 1.874000004359654.em,
        maxLines = -1,
        modifier = modifier.requiredWidth(89.0.dp).requiredHeight(28.964111328125.dp).wrapContentHeight(
            align = Alignment.CenterVertically,
            unbounded = true
        )
    )
...
fun HeaderRow(
    ...
    RelayContainer(
        ...
        clipToParent = false,
        content = content,
        modifier = modifier.requiredWidth(312.0.dp).requiredHeight(51.923828125.dp)
    )
}
...
fun MyPackages(modifier: Modifier = Modifier) {
    RelayText(
        ...
        fontWeight = FontWeight(700.0.toInt()),
        maxLines = -1,
        modifier = modifier.requiredWidth(145.0.dp).requiredHeight(39.29473876953125.dp).wrapContentHeight(
            align = Alignment.CenterVertically,
            unbounded = true
        )
    )
...
fun Table(
    ...
    RelayContainer(
        ...
        clipToParent = false,
        content = content,
        modifier = modifier.requiredWidth(313.0.dp).requiredHeight(390.0.dp)
    )
}
...
fun Rectangle70(modifier: Modifier = Modifier) {
    RelayVector(
        vector = painterResource(R.drawable.package_info_show_label_rectangle_70),
        modifier = modifier.requiredWidth(90.0.dp).requiredHeight(110.0.dp)
    )
}

@Composable
fun AmazonQRCode(modifier: Modifier = Modifier) {
    RelayText(
        ...
        fontWeight = FontWeight(700.0.toInt()),
        maxLines = -1,
        modifier = modifier.requiredWidth(63.89990234375.dp).requiredHeight(44.0.dp)
    )
}
...
fun Vector3(modifier: Modifier = Modifier) {
    RelayVector(
        vector = painterResource(R.drawable.package_info_show_label_vector3),
        modifier = modifier.padding(
            paddingValues = PaddingValues(
                start = 11.25.dp,
                top = 4.40704345703125.dp,
                end = 11.25.dp,
                bottom = 4.4071044921875.dp
            )
...
fun Vector4(modifier: Modifier = Modifier) {
    RelayVector(
        vector = painterResource(R.drawable.package_info_show_label_vector4),
        modifier = modifier.padding(
            paddingValues = PaddingValues(
                start = 4.6875.dp,
                top = 10.576904296875.dp,
                end = 4.6875.dp,
                bottom = 10.57696533203125.dp
            )
        ).fillMaxWidth(1.0f).fillMaxHeight(1.0f)
    )
}
...
fun Plus1(
    ...
    RelayContainer(
        isStructured = false,
        content = content,
        modifier = modifier.requiredWidth(22.5.dp).requiredHeight(21.15386962890625.dp)
    )
}
...
fun Vector5(modifier: Modifier = Modifier) {
    RelayVector(
        vector = painterResource(R.drawable.package_info_show_label_vector5),
        modifier = modifier.padding(
            paddingValues = PaddingValues(
                start = 0.0.dp,
                top = 0.0023193359375.dp,
                end = 0.0.dp,
                bottom = 0.00164794921875.dp
            )
        ).fillMaxWidth(1.0f).fillMaxHeight(1.0f)
    )
}
...
fun AmazonIcon1(
    ...
    RelayContainer(
        isStructured = false,
        content = content,
        modifier = modifier.requiredWidth(33.47998046875.dp).requiredHeight(33.0.dp)
    )
}
...
fun Rectangle72(modifier: Modifier = Modifier) {
    RelayVector(
        vector = painterResource(R.drawable.package_info_show_label_rectangle_72),
        modifier = modifier.requiredWidth(90.0.dp).requiredHeight(110.0.dp)
    )
}

@Composable
fun PhysicalLabel(modifier: Modifier = Modifier) {
    RelayText(
...
fun Vector6(modifier: Modifier = Modifier) {
    RelayVector(
        vector = painterResource(R.drawable.package_info_show_label_vector6),
        modifier = modifier.padding(
            paddingValues = PaddingValues(
                start = 11.25.dp,
                top = 4.40704345703125.dp,
...
fun Vector7(modifier: Modifier = Modifier) {
    RelayVector(
        vector = painterResource(R.drawable.package_info_show_label_vector7),
        modifier = modifier.padding(
            paddingValues = PaddingValues(
                start = 4.6875.dp,
                top = 10.576904296875.dp,
...
fun Vector8(modifier: Modifier = Modifier) {
    RelayVector(
        vector = painterResource(R.drawable.package_info_show_label_vector8),
...
fun Group(
    ...
    RelayContainer(
        ...
        modifier = modifier.padding(
            paddingValues = PaddingValues(
                start = 3.26953125.dp,
                top = 6.8353271484375.dp,
                end = 1.1886672973632812.dp,
                bottom = 8.916099548339844.dp
            )
        ).fillMaxWidth(1.0f).fillMaxHeight(1.0f)
    )
}
...
fun Vector9(modifier: Modifier = Modifier) {
    RelayVector(
        vector = painterResource(R.drawable.package_info_show_label_vector9),
        modifier = modifier.padding(
            paddingValues = PaddingValues(
                start = 0.0.dp,
                top = 0.0.dp,
                end = 12.4931640625.dp,
                bottom = 7.78021240234375.dp
            )
        ).fillMaxWidth(1.0f).fillMaxHeight(1.0f)
    )
}
...
fun Vector10(modifier: Modifier = Modifier) {
    RelayVector(
        vector = painterResource(R.drawable.package_info_show_label_vector10),
        modifier = modifier.padding(
            paddingValues = PaddingValues(
                start = 12.4931640625.dp,
                top = 0.000244140625.dp,
                end = 0.0.dp,
                bottom = 7.77996826171875.dp
            )
        ).fillMaxWidth(1.0f).fillMaxHeight(1.0f)
    )
}
...
fun Vector11(modifier: Modifier = Modifier) {
    RelayVector(
        vector = painterResource(R.drawable.package_info_show_label_vector11),
        modifier = modifier.padding(
            paddingValues = PaddingValues(
                start = 0.0.dp,
                top = 7.780029296875.dp,
                end = 12.4931640625.dp,
                bottom = 0.00018310546875.dp
            )
        ).fillMaxWidth(1.0f).fillMaxHeight(1.0f)
    )
}
...
fun Vector12(modifier: Modifier = Modifier) {
    RelayVector(
        vector = painterResource(R.drawable.package_info_show_label_vector12),
        modifier = modifier.padding(
            paddingValues = PaddingValues(
                start = 12.4931640625.dp,
                top = 7.78021240234375.dp,
                end = 0.0.dp,
                bottom = 0.0.dp
            )
        ).fillMaxWidth(1.0f).fillMaxHeight(1.0f)
...
fun Vector13(modifier: Modifier = Modifier) {
    RelayVector(
        vector = painterResource(R.drawable.package_info_show_label_vector13),
        modifier = modifier.padding(
            paddingValues = PaddingValues(
                start = 1.943359375.dp,
                top = 1.83721923828125.dp,
                end = 14.28125.dp,
                bottom = 1.83721923828125.dp
            )
        ).fillMaxWidth(1.0f).fillMaxHeight(1.0f)
    )
}
...
fun Vector14(modifier: Modifier = Modifier) {
    RelayVector(
        vector = painterResource(R.drawable.package_info_show_label_vector14),
        modifier = modifier.padding(
            paddingValues = PaddingValues(
                start = 6.05615234375.dp,
                top = 1.83721923828125.dp,
                end = 10.1689453125.dp,
                bottom = 1.83721923828125.dp
            )
        ).fillMaxWidth(1.0f).fillMaxHeight(1.0f)
    )
...
fun Vector15(modifier: Modifier = Modifier) {
    RelayVector(
        vector = painterResource(R.drawable.package_info_show_label_vector15),
        modifier = modifier.padding(
            paddingValues = PaddingValues(
...
fun Vector16(modifier: Modifier = Modifier) {
    RelayVector(
        vector = painterResource(R.drawable.package_info_show_label_vector16),
        modifier = modifier.padding(
            paddingValues = PaddingValues(
                start = 12.22509765625.dp,
                top = 1.83721923828125.dp,
                end = 4.0.dp,
                bottom = 1.83721923828125.dp
            )
...
fun Vector17(modifier: Modifier = Modifier) {
    RelayVector(
        vector = painterResource(R.drawable.package_info_show_label_vector17),
        modifier = modifier.padding(
            paddingValues = PaddingValues(
...
fun Group1(
    ...
    RelayContainer(
        ...
        modifier = modifier.padding(
            paddingValues = PaddingValues(
                start = 1.7998046875.dp,
                top = 4.65386962890625.dp,
                end = 1.7158203125.dp,
...
fun Rectangle73(modifier: Modifier = Modifier) {
    RelayVector(
        vector = painterResource(R.drawable.package_info_show_label_rectangle_73),
        modifier = modifier.requiredWidth(90.0.dp).requiredHeight(110.0.dp)
    )
}

@Composable
fun DigitalLabel(modifier: Modifier = Modifier) {
    RelayText(
...
fun Vector18(modifier: Modifier = Modifier) {
    RelayVector(
        vector = painterResource(R.drawable.package_info_show_label_vector18),
        modifier = modifier.padding(
            paddingValues = PaddingValues(
                start = 11.25.dp,
                top = 4.40704345703125.dp,
...
fun Vector19(modifier: Modifier = Modifier) {
    RelayVector(
        vector = painterResource(R.drawable.package_info_show_label_vector19),
        modifier = modifier.padding(
            paddingValues = PaddingValues(
                start = 4.6875.dp,
                top = 10.576904296875.dp,
...
fun Vector20(modifier: Modifier = Modifier) {
    RelayVector(
        vector = painterResource(R.drawable.package_info_show_label_vector20),
        modifier = modifier.fillMaxWidth(1.0f).fillMaxHeight(1.0f)
    )
}
...
fun Group2(
    ...
    RelayContainer(
        ...
        modifier = modifier.padding(
            paddingValues = PaddingValues(
                start = 2.81298828125.dp,
                top = 3.701904296875.dp,
                end = 2.81298828125.dp,
                bottom = 3.70062255859375.dp
            )
        ).fillMaxWidth(1.0f).fillMaxHeight(1.0f)
    )
}
...
fun Vector21(modifier: Modifier = Modifier) {
    RelayVector(
        vector = painterResource(R.drawable.package_info_show_label_vector21),
        modifier = modifier.padding(
            paddingValues = PaddingValues(
                start = 0.0.dp,
                top = 0.0.dp,
...
fun Vector22(modifier: Modifier = Modifier) {
    RelayVector(
        vector = painterResource(R.drawable.package_info_show_label_vector22),
        modifier = modifier.padding(
            paddingValues = PaddingValues(
                start = 12.4931640625.dp,
                top = 0.00018310546875.dp,
                end = 0.0.dp,
...
fun Vector23(modifier: Modifier = Modifier) {
    RelayVector(
        vector = painterResource(R.drawable.package_info_show_label_vector23),
        modifier = modifier.padding(
            paddingValues = PaddingValues(
                start = 0.0.dp,
                top = 7.780029296875.dp,
...
fun Vector24(modifier: Modifier = Modifier) {
    RelayVector(
        vector = painterResource(R.drawable.package_info_show_label_vector24),
        modifier = modifier.padding(
            paddingValues = PaddingValues(
                start = 12.4931640625.dp,
                top = 7.78021240234375.dp,
...
fun Vector25(modifier: Modifier = Modifier) {
    RelayVector(
        vector = painterResource(R.drawable.package_info_show_label_vector25),
        modifier = modifier.padding(
            paddingValues = PaddingValues(
                start = 1.943359375.dp,
                top = 1.83721923828125.dp,
...
fun Vector26(modifier: Modifier = Modifier) {
    RelayVector(
        vector = painterResource(R.drawable.package_info_show_label_vector26),
        modifier = modifier.padding(
            paddingValues = PaddingValues(
                start = 6.05615234375.dp,
                top = 1.83721923828125.dp,
...
fun Vector27(modifier: Modifier = Modifier) {
    RelayVector(
        vector = painterResource(R.drawable.package_info_show_label_vector27),
        modifier = modifier.padding(
            paddingValues = PaddingValues(
                start = 10.16845703125.dp,
                top = 1.83721923828125.dp,
...
fun Vector28(modifier: Modifier = Modifier) {
    RelayVector(
        vector = painterResource(R.drawable.package_info_show_label_vector28),
        modifier = modifier.padding(
            paddingValues = PaddingValues(
                start = 12.22509765625.dp,
                top = 1.83721923828125.dp,
...
fun Vector29(modifier: Modifier = Modifier) {
    RelayVector(
        vector = painterResource(R.drawable.package_info_show_label_vector29),
        modifier = modifier.padding(
            paddingValues = PaddingValues(
                start = 16.337890625.dp,
                top = 1.83721923828125.dp,
...
fun Group3(
    ...
    RelayContainer(
        ...
        modifier = modifier.padding(
            paddingValues = PaddingValues(
                start = 1.7578125.dp,
                top = 4.55389404296875.dp,
                end = 1.7578125.dp,
                bottom = 4.55389404296875.dp
            )
        ).fillMaxWidth(1.0f).fillMaxHeight(1.0f)
    )
}
...
fun NounBarcode5504918008BE72(
    ...
    RelayContainer(
        ...
        modifier = modifier.padding(
            paddingValues = PaddingValues(
                start = 6.75.dp,
                top = 3.80767822265625.dp,
                end = 6.75.dp,
                bottom = 8.88458251953125.dp
            )
        ).fillMaxWidth(1.0f).fillMaxHeight(1.0f)
    )
}
...
fun NounWeb5850602008BE71(
    ...
    RelayContainer(
        isStructured = false,
        content = content,
        modifier = modifier.requiredWidth(36.0.dp).requiredHeight(33.84613037109375.dp)
    )
}
...
fun Vector30(modifier: Modifier = Modifier) {
    RelayVector(
        vector = painterResource(R.drawable.package_info_show_label_vector30),
        modifier = modifier.padding(
            paddingValues = PaddingValues(
                start = 3.0.dp,
                top = 4.5.dp,
...
fun Button9(
    ...
    RelayContainer(
        ...
        radius = 50.0,
        content = content,
        modifier = modifier.requiredWidth(150.0.dp).requiredHeight(55.0.dp)
    )
}
...
fun Vector31(modifier: Modifier = Modifier) {
    RelayVector(
        vector = painterResource(R.drawable.package_info_show_label_vector31),
        modifier = modifier.padding(
            paddingValues = PaddingValues(
