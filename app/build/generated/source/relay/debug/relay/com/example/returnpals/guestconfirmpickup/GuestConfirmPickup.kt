package com.example.returnpals.guestconfirmpickup
...
/**
 * This composable was generated from the UI Package 'guest_confirm_pickup'.
 * Generated code; do not edit directly
 */
@Composable
fun GuestConfirmPickup(modifier: Modifier = Modifier) {
...
@Composable
private fun GuestConfirmPickupPreview() {
    MaterialTheme {
        RelayContainer {
            GuestConfirmPickup(modifier = Modifier.rowWeight(1.0f).columnWeight(1.0f))
        }
    }
}
...
fun Background(modifier: Modifier = Modifier) {
    RelayVector(
        vector = painterResource(R.drawable.guest_confirm_pickup_background),
...
fun Vector(modifier: Modifier = Modifier) {
    RelayVector(
        vector = painterResource(R.drawable.guest_confirm_pickup_vector),
...
fun Vector1(modifier: Modifier = Modifier) {
    RelayVector(
        vector = painterResource(R.drawable.guest_confirm_pickup_vector1),
        modifier = modifier.padding(
            paddingValues = PaddingValues(
...
fun Rectangle65(modifier: Modifier = Modifier) {
    RelayVector(
        vector = painterResource(R.drawable.guest_confirm_pickup_rectangle_65),
...
fun Rectangle40(modifier: Modifier = Modifier) {
    RelayVector(
        vector = painterResource(R.drawable.guest_confirm_pickup_rectangle_40),
        modifier = modifier.requiredWidth(271.0986328125.dp).requiredHeight(47.0673828125.dp)
    )
}
...
fun Rectangle66(modifier: Modifier = Modifier) {
    RelayVector(
        vector = painterResource(R.drawable.guest_confirm_pickup_rectangle_66),
        modifier = modifier.requiredWidth(93.638671875.dp).requiredHeight(47.0673828125.dp)
    )
}
...
fun Apply(modifier: Modifier = Modifier) {
    RelayText(
        ...
        fontWeight = FontWeight(500.0.toInt()),
        maxLines = -1,
        modifier = modifier.requiredWidth(73.24951171875.dp).requiredHeight(30.563232421875.dp)
    )
}
...
fun Packages1(modifier: Modifier = Modifier) {
    RelayText(
        ...
        fontWeight = FontWeight(500.0.toInt()),
        maxLines = -1,
        modifier = modifier.requiredWidth(155.70751953125.dp).requiredHeight(24.20458984375.dp).wrapContentHeight(
...
fun Class1PackageWithDigitalLabel(modifier: Modifier = Modifier) {
    RelayText(
        ...
        textAlign = TextAlign.Left,
        maxLines = -1,
        modifier = modifier.requiredWidth(265.30712890625.dp).requiredHeight(33.518310546875.dp)
    )
}
...
fun Vector2(modifier: Modifier = Modifier) {
    RelayVector(
        vector = painterResource(R.drawable.guest_confirm_pickup_vector2),
        modifier = modifier.requiredWidth(40.96875.dp).requiredHeight(33.584228515625.dp)
    )
}
...
fun VisaEndingIn4832(modifier: Modifier = Modifier) {
    RelayText(
        ...
        fontWeight = FontWeight(700.0.toInt()),
        maxLines = -1,
        modifier = modifier.requiredWidth(281.15087890625.dp).requiredHeight(39.1533203125.dp)
    )
}
...
fun OrderSummary(modifier: Modifier = Modifier) {
    RelayText(
        ...
        fontWeight = FontWeight(700.0.toInt()),
        maxLines = -1,
        modifier = modifier.requiredWidth(187.27685546875.dp).requiredHeight(50.99169921875.dp)
    )
}
...
fun Line10(modifier: Modifier = Modifier) {
    RelayVector(
        vector = painterResource(R.drawable.guest_confirm_pickup_line_10),
...
fun Rectangle56(modifier: Modifier = Modifier) {
    RelayVector(
        vector = painterResource(R.drawable.guest_confirm_pickup_rectangle_56),
...
fun Ellipse18(modifier: Modifier = Modifier) {
    RelayVector(
        vector = painterResource(R.drawable.guest_confirm_pickup_ellipse_18),
...
fun Line6(modifier: Modifier = Modifier) {
    RelayVector(
        vector = painterResource(R.drawable.guest_confirm_pickup_line_6),
...
fun Ellipse19(modifier: Modifier = Modifier) {
    RelayVector(
        vector = painterResource(R.drawable.guest_confirm_pickup_ellipse_19),
        modifier = modifier.requiredWidth(25.0.dp).requiredHeight(25.0.dp)
    )
}
...
fun Line5(modifier: Modifier = Modifier) {
    RelayVector(
        vector = painterResource(R.drawable.guest_confirm_pickup_line_5),
        modifier = modifier.requiredWidth(50.0.dp).requiredHeight(0.0.dp)
    )
}
...
fun Line4(modifier: Modifier = Modifier) {
    RelayVector(
        vector = painterResource(R.drawable.guest_confirm_pickup_line_4),
        modifier = modifier.requiredWidth(50.0.dp).requiredHeight(0.0.dp)
    )
}
...
fun Line3(modifier: Modifier = Modifier) {
    RelayVector(
        vector = painterResource(R.drawable.guest_confirm_pickup_line_3),
        modifier = modifier.requiredWidth(50.0.dp).requiredHeight(0.0.dp)
    )
}
...
fun Ellipse14(modifier: Modifier = Modifier) {
    RelayVector(
        vector = painterResource(R.drawable.guest_confirm_pickup_ellipse_14),
        modifier = modifier.requiredWidth(25.0.dp).requiredHeight(25.0.dp)
    )
}
...
fun Ellipse15(modifier: Modifier = Modifier) {
    RelayVector(
        vector = painterResource(R.drawable.guest_confirm_pickup_ellipse_15),
        modifier = modifier.requiredWidth(25.0.dp).requiredHeight(25.0.dp)
    )
}
...
fun Ellipse20(modifier: Modifier = Modifier) {
    RelayVector(
        vector = painterResource(R.drawable.guest_confirm_pickup_ellipse_20),
        modifier = modifier.requiredWidth(25.0.dp).requiredHeight(25.0.dp)
    )
}
...
fun Vector3(modifier: Modifier = Modifier) {
    RelayVector(
        vector = painterResource(R.drawable.guest_confirm_pickup_vector3),
...
fun Vector4(modifier: Modifier = Modifier) {
    RelayVector(
        vector = painterResource(R.drawable.guest_confirm_pickup_vector4),
        modifier = modifier.requiredWidth(18.0.dp).requiredHeight(12.760009765625.dp)
    )
}
...
fun Vector5(modifier: Modifier = Modifier) {
    RelayVector(
        vector = painterResource(R.drawable.guest_confirm_pickup_vector5),
        modifier = modifier.requiredWidth(18.0.dp).requiredHeight(12.760009765625.dp)
    )
}
...
fun Vector6(modifier: Modifier = Modifier) {
    RelayVector(
        vector = painterResource(R.drawable.guest_confirm_pickup_vector6),
        modifier = modifier.requiredWidth(18.0.dp).requiredHeight(12.760009765625.dp)
    )
}
