...
class GuestScreen : ComponentActivity() {
...
@Composable
fun MemberScreenContent2() {
    Scaffold(
        topBar = { MemberTopAppBar2() },
        ...
        Surface(
            ...
            Greeting("Guest") // Your screen content
        }
    }
}
